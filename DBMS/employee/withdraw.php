...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($amount <= 0) {
    ...
    } elseif ($amount > $customer['balance']) {
        $_SESSION['error'] = "Insufficient funds. Available balance: $" . number_format($customer['balance'], 2);
    } else {
        // Start transaction
        ...
        try {
            ...
            $pdo->commit();
            $_SESSION['success'] = "Withdrawal of $" . number_format($amount, 2) . " has been processed successfully.";
...
<head>
    ...
    <title>Process Withdrawal - SecureBank</title>
...
<body>
    <div class="withdraw-container">
        ...
        <div class="customer-info">
            ...
            <p><strong>Available Balance:</strong> $<?php echo number_format($customer['balance'], 2); ?></p>
        </div>
        ...
        <form method="POST" action="">
            <div class="form-group">
                ...
                <input type="number" id="amount" name="amount" step="0.01" min="0.01" max="<?php echo $customer['balance']; ?>" required>
            </div>

            <div class="form-group">
                <label for="description">Description (Optional)</label>
                <input type="text" id="description" name="description" placeholder="Enter withdrawal description">
            </div>
