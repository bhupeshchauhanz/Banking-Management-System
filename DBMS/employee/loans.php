...
try {
    // Get all loans with customer and account details
    $stmt = $pdo->query("
        SELECT l.id, l.amount, l.interest_rate, l.term_months, l.status, l.created_at,
...
<head>
    ...
    <title>Loan Management - SecureBank</title>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div>
                                <div style="font-weight: 600;">Loan #<?php echo $loan['id']; ?></div>
                                <div style="font-size: 0.85rem; color: var(--text-secondary); margin-top: 5px;">
                                    <?php echo date('M d, Y h:i A', strtotime($loan['created_at'])); ?>
                                </div>
                                <div style="font-size: 0.85rem; color: var(--text-secondary); margin-top: 5px;">
                        ...
                        <td>
                            <div style="display: flex; align-items: center; gap: 10px;">
                                <?php if ($loan['profile_photo']): ?>
                                    <img src="../uploads/profile_photos/<?php echo htmlspecialchars($loan['profile_photo']); ?>" alt="Profile Photo" style="width: 40px; height: 40px; border-radius: 50%; object-fit: cover;">
                                <?php else: ?>
                                ...
                                <div>
                                    ...
                                    <div style="font-size: 0.85rem; color: var(--text-secondary);"><?php echo htmlspecialchars($loan['username']); ?></div>
                                </div>
                            </div>
                        </td>
                        <td>
                            <div style="font-weight: 600;"><?php echo htmlspecialchars($loan['account_number']); ?></div>
                            <div style="font-size: 0.85rem; color: var(--text-secondary);">Balance: $<?php echo number_format($loan['balance'], 2); ?></div>
                        </td>
                        <td>
                            ...
                            <div style="font-size: 0.85rem; color: var(--text-secondary);">
                                Total with Interest: $<?php echo number_format($loan['amount'] * (1 + $loan['interest_rate']/100), 2); ?>
                            </div>
                        </td>
                        <td>
                        ...
                        <td>
                            <div style="display: flex; gap: 10px;">
                                <?php if ($loan['status'] === 'pending'): ?>
                                    <a href="approve_loan.php?id=<?php echo $loan['id']; ?>" class="btn btn-success btn-sm">
                                        <i class="fas fa-check"></i> Approve
                                    </a>
                                    <a href="reject_loan.php?id=<?php echo $loan['id']; ?>" class="btn btn-danger btn-sm">
